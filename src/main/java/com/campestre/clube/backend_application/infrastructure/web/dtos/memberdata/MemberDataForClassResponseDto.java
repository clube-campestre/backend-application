...
public class MemberDataForClassResponseDto {
    ...
    public MemberDataForClassResponseDto(String instructorName, Integer pageNumber, Integer pageSize, Long totalItems, Integer totalPages, List<MemberDataResponseDto> members) {
