...
public class StatementController {
    ...
    @PostMapping
    public ResponseEntity<StatementResponseDto> register(@Valid @RequestBody StatementRequestDto dto){
    ...
    public ResponseEntity<StatementResponseDto> update(
            @Valid @RequestBody StatementRequestDto dto, @PathVariable Integer id
    ){
