...
public class MedicalDataMapper {
    ...
    public static GetMedicalDataResponseDto toGetResponse(MedicalData medicalData) {
    ...
    public static SaveMedicalDataResponseDto toSaveResponse(MedicalData medicalData) {
